...
### :white_tick: Task 1 – Sentiment Classification
...
---
### :white_tick: Task 2 – Product Clustering
...
---
### :white_tick: Task 3 – GPT Summarization & Insights
...
---
### :white_tick: Final Stage – Deployment
- Built with **Flask**
- Allows:
  - Uploading CSV files
